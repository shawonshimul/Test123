...
public class ExcelDataProvider {
	...
	public ExcelDataProvider() {
		try {
			wb= new XSSFWorkbook(new FileInputStream(new File(System.getProperty("user.dir")+"/TestData\\automationpractice.xlsx")));
		}catch(IOException e) 
		{
	...
	public String getCellData(String sheetName, int row, int col) 
	{
		...
		String data=null; //if any cell is empty then ignore it
